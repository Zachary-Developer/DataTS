...
const { decodeParams, encodeMethod, logDecoder, } = __webpack_require__(18);
function ensureHex0x(hexstr) {
...
function decodeLogs(methods, logs) {
    ...
    return parsedLogs.map((log) => {
        ...
        for (const input of logABI.inputs) {
            decodedLog[input.name] = log[input.name];
        }
        return decodedLog;
    });
}
...
const sleep_1 = __webpack_require__(27);
...
var numberToBN = __webpack_require__(21);
var keccak256 = __webpack_require__(25).keccak_256;
...
var stripHexPrefix = __webpack_require__(23);
...
Object.defineProperty(exports, "__esModule", { value: true });
const abi_1 = __webpack_require__(5);
const TxReceiptPromise_1 = __webpack_require__(7);
class Contract {
    ...
    async rawCall(method, args = [], opts = {}) {
        ...
        // TODO decode?
        return this.rpc.callContrct(Object.assign({ address: this.address, datahex: calldata, senderAddress: this.info.sender }, opts));
    }
    ...
    async rawSend(method, args, opts = {}) {
        ...
        return this.rpc.sendToContract(Object.assign({ address: this.address, datahex: calldata, senderAddress: this.info.sender }, opts));
    }
    async confirm(tx, confirm, onConfirm) {
        const txrp = new TxReceiptPromise_1.TxReceiptPromise(this.rpc, tx.txid);
        if (onConfirm) {
    ...
    async send(method, args, opts = {}) {
        ...
        const calldata = abi_1.encodeInputs(methodABI, args);
        const sent = await this.rpc.sendToContract(Object.assign({ datahex: calldata, address: this.address, senderAddress: this.info.sender }, opts));
    ...
    _makeSendTxReceipt(receipt) {
        ...
        const logs = abi_1.decodeLogs(this.info.abi, rawlogs);
...
Object.defineProperty(exports, "__esModule", { value: true });
const QtumRPCRaw_1 = __webpack_require__(29);
